...
First I would Load and Explore the Data. Then I would need to do some Pre-Process, where i need to convert the data form a wide-table format to tall-table.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxMjA0NzAwOSwxODEyODg1NjE4LC0xND
