...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;f(x)=\frac{{b^2-4ac}}{2a}" title="\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" />
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzUzNzc2ODUsNjUyMTEzOTQ1LC0xNT
